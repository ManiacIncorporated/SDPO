...
class SelfDistillationConfig(BaseConfig):
    ...
    Args:
        ...
        kl_pointwise_clip (Optional[float]): Per-vocabulary-entry KL clip; caps each entry before summing over vocab. Prevents epistemic tokens from dominating the gradient (OPSD insight). None disables.
    ...
    kl_pointwise_clip: Optional[float] = None
